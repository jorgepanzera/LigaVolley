...
public sealed class MatchLineupPosition
{
    ...
    public int MatchLineupPositionId { get; private set; }
    public int MatchLineupId { get; private set; }
    public MatchLineup MatchLineup { get; private set; } = null!;
    public LineupPosition Position { get; private set; }
    public int MatchPlayerId { get; private set; }
    public MatchPlayer MatchPlayer { get; private set; } = null!;
}

public sealed class MatchSetLiberoPlan
{
    private MatchSetLiberoPlan() { }
    public MatchSetLiberoPlan(MatchSet set, MatchTeam team, MatchPlayer libero, byte logicalPositionsMask)
    {
        if (logicalPositionsMask is 0 or > 63) throw new DomainValidationException("At least one valid logical position is required.");
        MatchSet = set; MatchTeam = team; Libero = libero; LogicalPositionsMask = logicalPositionsMask;
    }
    public int MatchSetLiberoPlanId { get; private set; }
    public int MatchSetId { get; private set; }
    public MatchSet MatchSet { get; private set; } = null!;
    public int MatchTeamId { get; private set; }
    public MatchTeam MatchTeam { get; private set; } = null!;
    public int LiberoMatchPlayerId { get; private set; }
    public MatchPlayer Libero { get; private set; } = null!;
    public byte LogicalPositionsMask { get; private set; }
    public IReadOnlyList<LineupPosition> LogicalPositions => Enumerable.Range(0, 6).Where(i => (LogicalPositionsMask & (1 << i)) != 0).Select(i => (LineupPosition)(i + 1)).ToArray();
    public void Replace(MatchPlayer libero, byte logicalPositionsMask)
    {
        if (MatchSet.Status != MatchSetStatus.Ready) throw new DomainValidationException("Libero plan is locked.");
        Libero = libero; LiberoMatchPlayerId = libero.MatchPlayerId; LogicalPositionsMask = logicalPositionsMask;
    }
}
...
public sealed class MatchEvent
{
    ...
    public MatchSheetSession? MatchSheetSession { get; private set; }
    public long? LocalSequence { get; private set; }
    public string? SyncPayloadHash { get; private set; }
    public int? RelatedEventId { get; private set; }
    public MatchEvent? RelatedEvent { get; private set; }
    public void Cancel() { if (Status != MatchEventStatus.Active) throw new DomainValidationException("Event is already cancelled."); Status = MatchEventStatus.Cancelled; }
...
public sealed class MatchSubstitution
{
    ...
    public MatchSet MatchSet { get; private set; } = null!;
    public int MatchTeamId { get; private set; }
    public MatchTeam MatchTeam { get; private set; } = null!; public int PlayerOutMatchPlayerId { get; private set; }
    public MatchPlayer PlayerOut { get; private set; } = null!;
    public int PlayerInMatchPlayerId { get; private set; }
    public MatchPlayer PlayerIn { get; private set; } = null!; public LineupPosition LineupPosition { get; private set; }
    public DateTimeOffset OccurredAt { get; private set; }
}
...
public sealed class MatchLiberoReplacement
{
    ...
    public int MatchLiberoReplacementId { get; private set; }
    public Guid ReplacementUuid { get; private set; }
    public int MatchSetId { get; private set; }
    public MatchSet MatchSet { get; private set; } = null!;
    public int MatchTeamId { get; private set; }
    public MatchTeam MatchTeam { get; private set; } = null!; public int LiberoMatchPlayerId { get; private set; }
    public MatchPlayer Libero { get; private set; } = null!;
    public int ReplacedMatchPlayerId { get; private set; }
    public MatchPlayer Replaced { get; private set; } = null!; public LineupPosition LineupPosition { get; private set; }
