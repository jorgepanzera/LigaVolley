...
namespace LigaVolley.Api.Endpoints.Scorer;internal static class ScorerMatchOfficialEndpoints{public static IEndpointRouteBuilder MapScorerMatchOfficialEndpoints(this IEndpointRouteBuilder e){var g=e.MapGroup("/api/scorer/matches/{matchId:int}/officials").WithTags("Scorer Match Officials");
