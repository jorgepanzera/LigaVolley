...
public sealed record CreateCompetitionFormatRequest(string Code, string Name, string? Description, short MinTeams, short MaxTeams, CompetitionFormatDefinitionDto Definition, int MaxSubstitutionsPerSet = 6, int MaxTimeoutsPerSet = 2);
public sealed record UpdateCompetitionFormatRequest(string Code, string Name, string? Description, short MinTeams, short MaxTeams, CompetitionFormatDefinitionDto Definition, int MaxSubstitutionsPerSet = 6, int MaxTimeoutsPerSet = 2);
public sealed record CloneCompetitionFormatRequest(string Code, string Name, string? Description);
public sealed record ValidateCompetitionFormatRequest(short MinTeams, short MaxTeams, CompetitionFormatDefinitionDto Definition, string? Code = null, string? Name = null, int MaxSubstitutionsPerSet = 6, int MaxTimeoutsPerSet = 2);
...
public sealed record CompetitionFormatSummaryDto(int CompetitionFormatId, string Code, string Name, short MinTeams, short MaxTeams, bool Active, bool Used = false, bool IsStructurallyLocked = false, int UsedByDraftCompetitionCount = 0, int UsedByOperationalCompetitionCount = 0, int MaxSubstitutionsPerSet = 6, int MaxTimeoutsPerSet = 2);
