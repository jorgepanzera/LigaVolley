...
Public Live UX/UI v2: marcador mobile-first, cancha secundaria colapsable, frescura central 30/90 y resultado final por sets. El servidor se consume desde `servingPlayer`; no se deriva en React. Decisión completa en [docs](../../docs/08-public-query-and-live.md.).
