...
internal sealed class CompetitionConfiguration : IEntityTypeConfiguration<Competition>
{
    public void Configure(EntityTypeBuilder<Competition> b)
    {
        ...
        b.Property(x => x.PeriodType).AsSql("period_type", 20); b.Property(x => x.StartDate).HasColumnName("start_date").HasColumnType("date"); b.Property(x => x.EndDate).HasColumnName("end_date").HasColumnType("date"); b.Property(x => x.Status).AsSql("status", 20); b.Property(x=>x.CompletedAt).HasColumnName("completed_at").HasColumnType("datetimeoffset");
